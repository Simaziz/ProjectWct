         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-8 text-black">
          ...
          <div className="bg-white shadow-lg rounded-2xl overflow-hidden  p-[1rem]  ">
            ...
            <div className="p-6">
              ...
              <Link href="/Bodybuilding" className="text-blue-600 font-semibold mt-2 inline-block">
                View
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <Link href="/Martical" className="text-blue-600 font-semibold mt-2 inline-block">
                View
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <Link href="/Yoga" className="text-blue-600 font-semibold mt-2 inline-block">
                View
              </Link>
            </div>
          </div>
